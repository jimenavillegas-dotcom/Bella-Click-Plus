...
<body>
    <a href="makeup.html" target="_blank" id="botonMaquillaje" title="Asistente de Maquillaje">
  <img src="https://cdn-icons-png.flaticon.com/512/1998/1998615.png" alt="Asistente" />
  <style>
  #botonMaquillaje {
    position: fixed;
    bottom: 20px;
...
<style>
/* Estilos para el buscador - Estilo Mercado Libre */
.search-section {
    background: #fff159;
    padding: 20px 0;
    margin-bottom: 30px;
